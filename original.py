...
@app.route('/neural_network_satisfaction', methods=['GET', 'POST'])
def neural_network_satisfaction():
    try:
        ...
        # Return results to template
        return render_template(
            'neural_network_satisfaction.html',
...
@app.route('/decision_tree_churn', methods=['GET', 'POST'])
...
# Route: Churn Prediction with Random Forest
